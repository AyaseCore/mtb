...
namespace MSAToolBox
{
    ...
    public partial class locales_quest
    {
        ...
        public string CompletedText_loc1 { get; set; }
        public string CompletedText_loc2 { get; set; }
        public string CompletedText_loc3 { get; set; }
        public string CompletedText_loc4 { get; set; }
        public string CompletedText_loc5 { get; set; }
        public string CompletedText_loc6 { get; set; }
        public string CompletedText_loc7 { get; set; }
        public string CompletedText_loc8 { get; set; }
